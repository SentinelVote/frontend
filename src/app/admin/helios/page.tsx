...
export default function Page() {
  ...
  const data: Data[] = [
    ...
    { Hour: "3pm", Count: votingDetails?.countHour[22] },
    { Hour: "4pm", Count: votingDetails?.countHour[23] },
    { Hour: "5pm", Count: votingDetails?.countHour[0] },
    { Hour: "6pm", Count: votingDetails?.countHour[1] },
